...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { acc_id: @charity.acc_id, balance: @charity.balance, cust_id: @charity.cust_id, name: @charity.name } }
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { acc_id: @charity.acc_id, balance: @charity.balance, cust_id: @charity.cust_id, name: @charity.name } }
